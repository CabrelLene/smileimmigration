...
.tl { list-style: none; margin: 0; padding: 0; border-left: 2px solid rgba(255,255,255,.2); }
.tl li { position: relative; margin-left: 14px; padding: 10px 10px 10px 12px; }
.tl li .dot { position:absolute; left:-10px; top:16px; width:14px; height:14px; border-radius:50%; background:#5dd6ff; box-shadow:0 0 10px rgba(93,214,255,.6); }
</style>
